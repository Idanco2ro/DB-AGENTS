...
llm_name = "gpt-4.1-mini"  # Use your provided model name
...
database_file_path = "D:/My_project/DB-AGENTS/db/salaries_2023.db"

# SQLite only requires the path to the database file
engine = create_engine(f"sqlite:///{database_file_path}")
file_url = "D:/My_project/DB-AGENTS/Data/salaries_2023.csv"
...
def run_conversation(
    query=#"""What is the average salary and the count of female employees in the ABS 85 Administrative Services division?""",
